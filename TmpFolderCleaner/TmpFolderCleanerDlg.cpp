...
// TmpFolderCleanerDlg.cpp : implementation file
//
...
CTmpFolderCleanerDlg::CTmpFolderCleanerDlg(CWnd* pParent /*=nullptr*/)
	: CDialog(IDD_TMPFOLDERCLEANER_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CTmpFolderCleanerDlg, CDialog)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()


// CTmpFolderCleanerDlg message handlers
